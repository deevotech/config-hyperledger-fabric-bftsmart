...
$GOPATH/src/github.com/hyperledger/fabric/build/bin/configtxgen -profile SampleSingleMSPBFTsmart -channelID genesischannel -outputBlock $GENESIS_BLOCK_FILE
if [ "$?" -ne 0 ]; then
