...
for ORG in $PEER_ORGS; do
    ...
    $GOPATH/src/github.com/hyperledger/fabric/build/bin/peer chaincode install -n $n -v 1.0 -p github.com/hyperledger/fabric-samples/chaincode/chaincode_example02
